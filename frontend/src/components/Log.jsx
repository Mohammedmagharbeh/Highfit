...
// import { Phone, ArrowRight, Shield, Dumbbell, ChevronLeft } from "lucide-react";
...
//     try {
//       // تنظيف الرقم وإضافة مفتاح الدولة
...
//         setStep("otp");
//       } else {
//         alert(data.msg || "خطأ في إرسال الرمز");
//       }
//     } catch (error) {
//       console.error("Fetch error:", error);
//       alert("تعذر الاتصال بالسيرفر، تأكد أن الباك إند يعمل");
//     } finally {
//       setIsLoading(false);
//     }
//   };
...
//     if (otpString.length < 4) return; // عدلها لـ 4 بدل 6
//     setIsLoading(true);
...
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify({ phone: cleanPhone, otp: otpString }),
//       });
...
//   // معالجة إدخال الـ OTP وتنقله تلقائياً
...
//   // لازم تكون index < 3 لأن المربعات هي (0, 1, 2, 3)
//   if (value && index < 3) { 
