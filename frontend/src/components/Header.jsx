...
//           {/* إذا لم نكن في صفحة اللوجن، أظهر الروابط المعتادة */}
//           {!isLoginPage && (
...
//           {/* مفتاح اللغة - يظهر دائماً (حتى في صفحة اللوجن) */}
//           <div className={`${!isLoginPage ? "border-l border-white/20 pl-4" : ""}`}>
//             <LanguageSwitcher />
//           </div>

//           {/* زر المنيو للموبايل - يختفي في صفحة اللوجن لأنه لا يوجد روابط لعرضها */}
//           {!isLoginPage && (
...
//         {/* Mobile Menu - يختفي تماماً في صفحة اللوجن */}
//         {!isLoginPage && (
//           <div className={`absolute top-full left-0 right-0 bg-[#0a0a0a] border-b border-white/10 ${isMenuOpen ? "block" : "hidden"} md:hidden`}>
//             <div className="flex flex-col gap-6 p-6">
//               <a href="#about" onClick={() => setIsMenuOpen(false)} className="text-white/80">{t("about")}</a>
//               <a href="#programs" onClick={() => setIsMenuOpen(false)} className="text-white/80">{t("programs")}</a>
//               <a href="#contact" onClick={() => setIsMenuOpen(false)} className="text-white/80">{t("nav_contact")}</a>
//             </div>
//           </div>
//         )}
//       </div>
...
function Header() {
  ...
  return (
    <nav className="fixed w-full bg-[#0a0a0a]/95 backdrop-blur-md z-[999] border-b border-white/10 top-0 left-0">
      <div className="max-w-7xl mx-auto px-6 py-6 lg:py-8 flex items-center justify-between">
