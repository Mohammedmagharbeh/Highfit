...
//       */}
//       <main className={`${shouldShowHeader ? "pt-24 md:pt-28" : "pt-0"} pb-10 w-full`}>
//         <Routes>
...
function AppContent() {
  ...
  return (
    <div
      ...
      className={`${isAr ? "font-arabic" : "font-sans"} overflow-x-hidden w-full min-h-screen bg-[#0a0a0a]`}
    >
      {/* الهيدر يظهر دائماً في كل الصفحات */}
      <Header />

      <Toaster position="top-center" containerStyle={{ zIndex: 9999999 }} />

      {/* حشوة علوية ثابتة لضمان عدم اختفاء المحتوى تحت الهيدر الثابت */}
